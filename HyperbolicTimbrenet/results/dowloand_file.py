...
file_data = (
    "baseline/model_weights/baseline_latent_2_lr_3e-05_b_1_the_best.data-00000-of-00001"
)
...
file_index = (
    "breguel_model/model_weights/breguel_model_latent_2_lr_3e-05_b_1_the_best.index"
)
...
file_index = (
    "mircea_model/model_weights/mircea_model_latent_2_lr_3e-05_b_1_the_best.index"
)
...
file_data = (
    "hyp+vae/model_weights/hyp+vae_latent_2_lr_3e-05_b_1_the_best.data-00000-of-00001"
)
urllib.request.urlretrieve(url_index, file_index)
urllib.request.urlretrieve(url_data, file_data)
